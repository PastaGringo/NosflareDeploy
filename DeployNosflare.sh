...
CLOUDFLARE_API_TOKEN="DTxsAcKaW2M6qBWx2Kq8VSNaRqQt5DlQm9iKBMug"
relayInfo_name="My beautiful relay!"
relayURL="nosflare.plebes.fans"
relayInfo_description="A serverless Nostr relay through Cloudflare Worker and KV store"
relayInfo_pubkey="b12b632c887f0c871d140d37bcb6e7c1e1a80264d0b7de8255aa1951d9e1ff79"
relayInfo_contact="pastagringo@fractalized.net"
relayIcon_URL="https://picoshare.fractalized.net/-aPGn4avTgW/Laser%20Eyes%20Meme%20Maker.ico"
...
echo
echolor "Checking if Nosflare has already been installed here ..."
...
if test -f "$path_wrangler_toml"; then
    ...
    if test -f "$path_wrangler_toml"; then
        echo ">>> $path_wrangler_toml has been download ✅"
    else
